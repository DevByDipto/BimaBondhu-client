        ...
        <table className="table table-zebra w-full text-sm">
          ...
          <tbody>
            {rejectedApplications.map((app, index) => {
              ...
              const isApplicationRejected = app.application_status === 'rejected';
              ...
              const statusLabel = isAgentRejected ? 'Agent Rejected' : 'Application Rejected';

              const formattedDate = new Date(app?.created_at).toLocaleDateString('en-GB');
              ...
              return (
                <tr key={app._id}>
                  ...
                  <td>{app.email}</td>
                  <td>{rejectionType}</td>
                  <td className="max-w-xs whitespace-pre-wrap">{rejectionReason}</td>
                  <td>{formattedDate}</td>
