        ...
        <div className="modal modal-open">
          <div className="modal-box max-w-2xl">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                <strong>Amount:</strong> ${selectedPolicy.policy_amount}
              </p>
              <p>
                <strong>Claim Status:</strong> {selectedPolicy.claim_status}
              </p>
              <p>
                <strong>Reason:</strong> {selectedPolicy.reason}
              </p>
              <p>
                <strong>User Email:</strong> {selectedPolicy.user_email}
              </p>
              <p>
                <strong>Requested At:</strong>{" "}
                {new Date(selectedPolicy.requested_at).toLocaleString()}
              </p>
              <p>
